...
const connection = mysql.createConnection(
    ...
    });//will help create my database and run source schema.sql from here. We run the subsequent queries below. Organize structure in the schema.sql file then run it in the terminal with source schema.sql. 
